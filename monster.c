...
static void *snd[MN_TN][5];
static void *impsitsnd[2];
static void *impdthsnd[2];
static void *firsnd;
static void *slopsnd;
static void *gsnd[4];
static void *swgsnd;
static void *pchsnd;
static void *pl_spr[2];
static void *telesnd;
static void *positsnd[3];
static void *podthsnd[3];
...
//    if (Z_sign(mn[i].tx - mn[i].o.x) != mn[i].d * 2 - 1) {
//        return 0;
//    }
    switch (mn[i].t) {
        case MN_IMP:
